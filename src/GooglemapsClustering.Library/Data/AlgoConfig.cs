...
namespace GooglemapsClustering.Clustering.Data
{
    public class AlgoConfig
    {
        ...
        // Use debug data        
        public readonly bool DoShowGridLinesInGoogleMap; // generate draw grid lines info to google map
        ...
        public readonly int OuterGridExtend;

        // Merge cluster points
        public readonly bool DoUpdateAllCentroidsToNearestContainingPoint; // move centroid point to nearest existing point?
        public readonly bool DoMergeGridIfCentroidsAreCloseToEachOther; // merge clusterpoints if close to each other?
        public readonly double MergeWithin; // if neighbor cluster is within 1/n dist then merge, heuristic, higher value gives less merging

        // Cluster decision
        public readonly int MinClusterSize; // only cluster if minimum this number of points

        // If clustering is disabled, restrict number of markers returned
        public readonly int MaxMarkersReturned; 
        
        // Always cluster if equal or below this zoom level
        // to disable this effect set the value to -1
        public readonly int AlwaysClusteringEnabledWhenZoomLevelLess;
        
        // Stop clustering from this zoom level and larger
        public readonly int ZoomlevelClusterStop;

        
        // Pre cluster on app startup, NOT IMPLEMENTED YET
        public readonly bool PreClustered;
        ...
        public readonly HashSet<int> MarkerTypes;

        // Max allowed points in memory cache
        public readonly int MaxPointsInCache;
